...
export const metadata: Metadata = {
  title: "FreshMart Grocery - Fresh Local Produce & Organic Food",  description: "Shop fresh organic produce, local dairy, wild-caught seafood, and artisan bakery items at FreshMart Grocery. Your trusted neighborhood grocery store with weekly specials and quality products.",  keywords: "grocery store, fresh produce, organic food, local farmers market, fresh meat, dairy products",  metadataBase: new URL("https://freshmart.local"),
  alternates: {
    canonical: "https://freshmart.local"},
  openGraph: {
    title: "FreshMart Grocery - Fresh Organic Produce & Local Products",    description: "Discover fresh, locally-sourced groceries at FreshMart. Quality produce, premium meats, organic dairy, and fresh bakery items delivered daily.",    url: "https://freshmart.local",    siteName: "FreshMart Grocery",    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "FreshMart Grocery - Your Local Neighborhood Store",    description: "Fresh, organic, and locally-sourced groceries for your family. Visit us today!"},
  robots: {
    index: true,
    follow: true,
  },
